...
<html lang="en">
  <head>
    ...
    body{
        ...
        padding:0; 
        width:100vw;
        background:url("https://img.freepik.com/free-vector/hand-painted-watercolor-nature-background_23-2148941599.jpg?size=626&ext=jpg") center center no-repeat;
                      ...
                      <form v-on:submit.prevent>
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                            <button class="btn custom-button yellow-btn" :class="{'btn-success' : !enableEdit, 'btn-warning' : enableEdit}" type="button"  v-on:click="addTodo"><span :class="{'fa fa-plus' : !enableEdit, 'fa fa-edit' : enableEdit}"></span></button>
                          </span>
                        </div>
                      </form>
                      <ul class="list-group">
